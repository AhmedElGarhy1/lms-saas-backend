...
const files = [
  'src/modules/centers/controllers/branches-access.controller.ts',
  'src/modules/centers/controllers/branches-actions.controller.ts', 
  'src/modules/centers/controllers/centers-access-actions.controller.ts',
...
for (const file of files) {
  try {
    ...
    // Fix bulk operation ControllerResponse calls with count and item
...
console.log('Bulk operation fixes completed');
