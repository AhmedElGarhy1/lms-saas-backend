...
export type I18nTranslations = {
    ...
    "t": {
        ...
        "errors": {
            ...
            "adminScopeAccessDenied": string;
            "notAuthorizedToUpdateRole": string;
            "notAuthorizedToDeleteRole": string;
            "notAuthorizedToAccessRole": string;
            "roleNotDeletedCannotRestore": string;
            "seederFailed": string;
            "profileSelectionRequired": string;
